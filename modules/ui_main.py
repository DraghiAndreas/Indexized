...
################################################################################
## Form generated from reading UI file 'mainCVkHKX.ui'
##
...
"}")
        ...
        self.text_label_2 = QLabel(self.holdings_data_1)
        self.text_label_2.setObjectName(u"text_label_2")
        self.text_label_2.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 13px;")

        self.verticalLayout_35.addWidget(self.text_label_2)

        self.hd_1_label = QLabel(self.holdings_data_1)
        self.hd_1_label.setObjectName(u"hd_1_label")
        self.hd_1_label.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 24px;")

        self.verticalLayout_35.addWidget(self.hd_1_label)
        ...
        self.text_label_3 = QLabel(self.holdings_data_2)
        self.text_label_3.setObjectName(u"text_label_3")
        self.text_label_3.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 13px;")

        self.verticalLayout_36.addWidget(self.text_label_3)

        self.hd_2_label = QLabel(self.holdings_data_2)
        self.hd_2_label.setObjectName(u"hd_2_label")
        self.hd_2_label.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 23px;color:#2ecc71")

        self.verticalLayout_36.addWidget(self.hd_2_label)
        ...
        self.text_label_4 = QLabel(self.holdings_data_3)
        self.text_label_4.setObjectName(u"text_label_4")
        self.text_label_4.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 13px;")

        self.verticalLayout_37.addWidget(self.text_label_4)

        self.hd_3_label = QLabel(self.holdings_data_3)
        self.hd_3_label.setObjectName(u"hd_3_label")
        self.hd_3_label.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 24px;color:#ff4143")

        self.verticalLayout_37.addWidget(self.hd_3_label)
        ...
        self.holdings_graph = QFrame(self.portfolio)
...
"}")
        ...
        self.empty_2 = QFrame(self.hg_buttons)
        self.empty_2.setObjectName(u"empty_2")
        self.empty_2.setFrameShape(QFrame.Shape.StyledPanel)
        self.empty_2.setFrameShadow(QFrame.Shadow.Raised)

        self.horizontalLayout_17.addWidget(self.empty_2)
        ...
        self.horizontalLayout_17.setStretch(6, 20)

        self.verticalLayout_38.addWidget(self.hg_buttons)

        self.hg_frame = QFrame(self.holdings_graph)
        self.hg_frame.setObjectName(u"hg_frame")
        self.hg_frame.setStyleSheet(u"background-color: black")
        self.hg_frame.setFrameShape(QFrame.Shape.StyledPanel)
        self.hg_frame.setFrameShadow(QFrame.Shadow.Raised)

        self.verticalLayout_38.addWidget(self.hg_frame)

        self.verticalLayout_38.setStretch(0, 2)
        self.verticalLayout_38.setStretch(1, 10)

        self.verticalLayout_33.addWidget(self.holdings_graph)

        self.holdings_list_pie = QFrame(self.portfolio)
        self.holdings_list_pie.setObjectName(u"holdings_list_pie")
        self.holdings_list_pie.setFrameShape(QFrame.Shape.StyledPanel)
        self.holdings_list_pie.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_28 = QHBoxLayout(self.holdings_list_pie)
        self.horizontalLayout_28.setObjectName(u"horizontalLayout_28")
        self.horizontalLayout_28.setContentsMargins(-1, 0, -1, 0)
        self.frame_14 = QFrame(self.holdings_list_pie)
        ...
        self.text_label_6 = QLabel(self.frame_16)
        self.text_label_6.setObjectName(u"text_label_6")
        self.text_label_6.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 17px;")
        self.text_label_6.setMargin(0)
        self.text_label_6.setIndent(0)

        self.horizontalLayout_34.addWidget(self.text_label_6)

        self.graph_combo_box_2 = QComboBox(self.frame_16)
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.addItem("")
        ...
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.addItem("")
        self.graph_combo_box_2.setObjectName(u"graph_combo_box_2")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.graph_combo_box_2.sizePolicy().hasHeightForWidth())
        self.graph_combo_box_2.setSizePolicy(sizePolicy4)
        self.graph_combo_box_2.setStyleSheet(u"background-color: rgba(16,16,16,255);\n"
"")

        self.horizontalLayout_34.addWidget(self.graph_combo_box_2)
        ...
        self.horizontalLayout_34.setStretch(1, 30)
        self.horizontalLayout_34.setStretch(2, 30)
        ...
        self.text_label_7 = QLabel(self.frame_17)
        self.text_label_7.setObjectName(u"text_label_7")
        self.text_label_7.setStyleSheet(u"font: bold \"Segoe UI\"; font-size: 17px;")
        self.text_label_7.setMargin(0)
        self.text_label_7.setIndent(0)

        self.horizontalLayout_35.addWidget(self.text_label_7)

        self.plainTextEdit_2 = QPlainTextEdit(self.frame_17)
        self.plainTextEdit_2.setObjectName(u"plainTextEdit_2")
        self.plainTextEdit_2.setEnabled(True)
        self.plainTextEdit_2.setMaximumSize(QSize(16777215, 49))
        self.plainTextEdit_2.setStyleSheet(u"background-color:rgb(16,16,16)")
        self.plainTextEdit_2.setTabStopDistance(10.000000000000000)
        self.plainTextEdit_2.setBackgroundVisible(False)

        self.horizontalLayout_35.addWidget(self.plainTextEdit_2)
...
"}")
        ...
        self.horizontalLayout_36.addWidget(self.add_btn)

        self.subtract_btn = QPushButton(self.frame_15)
        ...
        self.horizontalLayout_36.addWidget(self.subtract_btn)
        ...
        self.holdings_pie_chart = QFrame(self.holdings_list_pie)
        self.holdings_pie_chart.setObjectName(u"holdings_pie_chart")
        self.holdings_pie_chart.setStyleSheet(u"background-color:black;")
...
" QScrollBar:horizontal { background: rgba(16,16,16,255); }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"CURRENCIES", None))
        ...
        self.text_label_2.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.hd_1_label.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.text_label_3.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.hd_2_label.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.text_label_4.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.hd_3_label.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        ...
        self.text_label_6.setText(QCoreApplication.translate("MainWindow", u"TICKERS:", None))
        self.graph_combo_box_2.setItemText(0, QCoreApplication.translate("MainWindow", u"VTI", None))
        self.graph_combo_box_2.setItemText(1, QCoreApplication.translate("MainWindow", u"SPY", None))
        self.graph_combo_box_2.setItemText(2, QCoreApplication.translate("MainWindow", u"VOO", None))
        self.graph_combo_box_2.setItemText(3, QCoreApplication.translate("MainWindow", u"SCHB", None))
        self.graph_combo_box_2.setItemText(4, QCoreApplication.translate("MainWindow", u"DIA", None))
        self.graph_combo_box_2.setItemText(5, QCoreApplication.translate("MainWindow", u"QQQ", None))
        self.graph_combo_box_2.setItemText(6, QCoreApplication.translate("MainWindow", u"-------", None))
        self.graph_combo_box_2.setItemText(7, QCoreApplication.translate("MainWindow", u"XLK", None))
        self.graph_combo_box_2.setItemText(8, QCoreApplication.translate("MainWindow", u"XLF", None))
        self.graph_combo_box_2.setItemText(9, QCoreApplication.translate("MainWindow", u"XLE", None))
        self.graph_combo_box_2.setItemText(10, QCoreApplication.translate("MainWindow", u"XLY", None))
        self.graph_combo_box_2.setItemText(11, QCoreApplication.translate("MainWindow", u"XLI", None))
        self.graph_combo_box_2.setItemText(12, QCoreApplication.translate("MainWindow", u"XLV", None))
        self.graph_combo_box_2.setItemText(13, QCoreApplication.translate("MainWindow", u"XLC", None))
        self.graph_combo_box_2.setItemText(14, QCoreApplication.translate("MainWindow", u"XLU", None))
        self.graph_combo_box_2.setItemText(15, QCoreApplication.translate("MainWindow", u"XLB", None))
        self.graph_combo_box_2.setItemText(16, QCoreApplication.translate("MainWindow", u"XLRE", None))
        self.graph_combo_box_2.setItemText(17, QCoreApplication.translate("MainWindow", u"VNQ", None))
        self.graph_combo_box_2.setItemText(18, QCoreApplication.translate("MainWindow", u"-------", None))
        self.graph_combo_box_2.setItemText(19, QCoreApplication.translate("MainWindow", u"VXUS", None))
        self.graph_combo_box_2.setItemText(20, QCoreApplication.translate("MainWindow", u"IXUS", None))
        self.graph_combo_box_2.setItemText(21, QCoreApplication.translate("MainWindow", u"VEU", None))
        self.graph_combo_box_2.setItemText(22, QCoreApplication.translate("MainWindow", u"-------", None))
        self.graph_combo_box_2.setItemText(23, QCoreApplication.translate("MainWindow", u"VIXY", None))
        self.graph_combo_box_2.setItemText(24, QCoreApplication.translate("MainWindow", u"SH", None))
        self.graph_combo_box_2.setItemText(25, QCoreApplication.translate("MainWindow", u"SQQQ", None))
        self.graph_combo_box_2.setItemText(26, QCoreApplication.translate("MainWindow", u"-------", None))
        self.graph_combo_box_2.setItemText(27, QCoreApplication.translate("MainWindow", u"BND", None))
        self.graph_combo_box_2.setItemText(28, QCoreApplication.translate("MainWindow", u"AGG", None))
        self.graph_combo_box_2.setItemText(29, QCoreApplication.translate("MainWindow", u"-------", None))
        self.graph_combo_box_2.setItemText(30, QCoreApplication.translate("MainWindow", u"ARKK", None))
        self.graph_combo_box_2.setItemText(31, QCoreApplication.translate("MainWindow", u"SOXX", None))

        self.text_label_7.setText(QCoreApplication.translate("MainWindow", u"AMOUNT: ", None))
